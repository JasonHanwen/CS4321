...
//	private ArrayList<String> AttributesOrder = new ArrayList<String>();
	...
	//we should sort the input according to the sortedList use for the orderbyItems
//	public Tuple(String input, ArrayList<String> sortedList){
//		String[] stringArray = input.split(",");
//		for(int i = 0; i < stringArray.length; i++){
//			content.add(stringArray[i]);
//		}
//		//add the sortedInitems and store them in a list of sortedItems
//		/**
//		 * add the method to store all element in attributesorder
//		 */
//	}
	/**
	 * @param SortedItems
